...
public class ListenerUtility implements ITestListener, IInvokedMethodListener {
	...
	public void onTestFailure(ITestResult result)
	{
		...
		String name = String.valueOf(count);			
		FileUtils.copyFile(f,new File("./Screenshot/" + name + ".png"));
		testid.get(cat).fail(result.getThrowable().getMessage(),MediaEntityBuilder.createScreenCaptureFromPath("../Screenshot/"+result.getMethod().getConstructorOrMethod().getMethod().getName()+".png").build());
		} catch (Exception e) {
			e.printStackTrace();
		}
